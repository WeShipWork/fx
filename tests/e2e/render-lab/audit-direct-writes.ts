...
const allowlist: AllowRule[] = [
  ...
  rule("src/core/llm/codex_login.zig", "writeStdout", /stdio_acquisition_write/, "noninteractive_output", "CLI codex login output"),
  rule("src/core/llm/xai_login.zig", "writeStdout", /stdio_acquisition_write/, "noninteractive_output", "CLI xAI login output"),
